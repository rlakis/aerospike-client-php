    ...
    function __construct(Router $router) {
        ...
        if ($userLogin && $this->isEmail($userLogin)) {
            ...
            if(isset($_SERVER['HTTP_REFERER']) && 
                    preg_match('/^(?:http|https)\:\/\/(?:www\.|dv\.|)mourjan\.com/', $_SERVER['HTTP_REFERER']) && 
                    $ref && 
                ...
                if ($this->urlRouter->siteLanguage!='ar' && !preg_match('/\/'.$this->urlRouter->siteLanguage.'\//', $ref)) { 
                    $ref.=$this->urlRouter->siteLanguage.'/';                     
                }
