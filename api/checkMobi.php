...
$jsnreq= json_decode( $request_body, TRUE ); //convert JSON into array

if (isset($jsnreq['key']) && isset($jsnreq['number']))
{
    NoSQL::getInstance()->mobileSetDeliveredCode($uid, intval($jsnreq['number']));
}
