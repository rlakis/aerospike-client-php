...
function toggleMenu(e) {
    se(), e = $(e), isMenuOpen ? (e.removeClass("on"), isMenuOpen = 0) : (e.addClass("on"), isMenuOpen = 1)
}

function showSearch() {
    se();
    var e = $(".qHolder", menu);
    e.addClass("on"), isSearchOpen = 1, setTimeout(function() {
        $("#q", e).focus()
    }, 0)
}

function hideSearch() {
    dontBlur || (se(), $(".qHolder", menu).removeClass("on"), isSearchOpen = 0)
}*/
var lastScrollTop = 0,
    isMenuUp = 0,
    isMenuOpen = 0,
