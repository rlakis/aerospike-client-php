...
return [ 
	...
	"providers"	=> [ 
		...
		"Yahoo" => [
			"enabled" => true,
            "wrapper" => [ "path" => "vendor/mourjan/hybridauth/additional-providers/hybridauth-yahoo-openid/Providers/Yahoo.php", "class" => "Hybrid_Providers_Yahoo" ]
		],
		...
		"Twitter" => [ 
			"enabled" => true,
			"keys"    => [ 
                  "key" => "fu7pQuCgMbBDaxdxfTn7DETJc",
                   "secret" => "GJfDJEkLIFlyzHm1JRF3MALMFIAprQTXdc3bU6fJ5jw0LF3XhC"]
		],
