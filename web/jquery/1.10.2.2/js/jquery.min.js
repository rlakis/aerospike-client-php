...
var Dialog = {
    ...
    call_ok:null,
    call_no:null,
    show : function(nodeId, content, callback_ok, callback_no){                  
        if(this.active){
            if (this.node !== null){
                this.node.fadeOut();
            }
    ...
    showMask : function(){if (this.mask === null){var m = $("#dialog-mask"); if (m.length === 0){m = $("<div id='dialog-mask'></div>"); $('body').append(m); this.mask = m}}this.mask.fadeIn()}, hideMask : function(){if (this.mask !== null){this.mask.fadeOut()}}}