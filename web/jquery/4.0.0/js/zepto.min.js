...
function ose(e) {
    var d = $('<div class="top"><form action="" method="get"><input type="search" id="q" name="q" onkeyup="idir(this)" onfocus="this.select()" value="" type="text" placeholder="' + (lang == 'ar' ? 'ما الذي تبحث عنه؟' : 'what are you looking for?') + '" /></form><span class="k cancel"></span></div>');
    var i = $('#q', d);
    osr(i);
    var f = function () {
        osr(i)
    ...
    var g = function(){        
        window.removeEventListener("resize", f, true);
        d.remove();
        window.removeEventListener("popstate", g, true);
    };
    ...
    window.addEventListener("popstate", g, true)
}
...
function side() {
    var d = $('<div><div class="top-shd"></div><div id="dialog-mask"></div></div>');
    var b = $('body');
    var kh = $('.top .k.home');
    var s = $('#side');
    d.append(s);
    ...
    $('#dialog-mask,.top-shd', d).click(function () {
        f();
        history.back()
    });
    s.addClass('on');
